var chemoCodes = angular.module('chemoCodes.directives', []);


//direective to break list into alphabetical sections
chemoCodes.directive('autoListDivider', function ($timeout) {
    var lastDivideKey = "";
